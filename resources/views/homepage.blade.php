        ...
        <div id="main-slide" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <img class="img-responsive" src="{{ $files[0]->photo}}" alt="slider">
                ...
                <div class="item">
                    <img class="img-responsive" src="{{$files[1]->photo}}" alt="slider">
                ...
                <a href="{{url('test')}}">
                <div class="item">
                    <img  class="img-responsive" src="{{$files[2]->photo}}" alt="slider">
                </a> 
